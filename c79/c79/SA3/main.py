...
background_image = pygame.image.load("C:/Users/arnav/Downloads/c79/c79/SA3/track.png").convert()
player_image = pygame.image.load("C:/Users/arnav/Downloads/c79/c79/SA3/car.png").convert_alpha()
...
def eval_fitness(generation, config):
    ...
    for gid, genome in generation:
        ...
        while True:
          ...
          # Use sensor data as input to the neural network (Make sure to change the number of inputs in cofig-feedforward.txt file)
          output = net.activate((angle, sensorData[0], sensorData[1], sensorData[2], sensorData[3], sensorData[4], 
                                 sensorData[5], sensorData[6], sensorData[7]))
          ...
          # Add fitness calculations for the cureent genome
          genome.fitness += 0.2
...
config = neat.config.Config(neat.DefaultGenome, neat.DefaultReproduction,neat.DefaultSpeciesSet, neat.DefaultStagnation,
                            'C:/Users/arnav/Downloads/c79/c79/SA3/config-feedforward.txt')  
